		...
		if recommendation_type is '1':
			...
			for result in top_5_artists_by_friends:
				...
				for artist in artists_by_id:
					artists_html += '<div class="col-sm-6 col-md-9"><div class="thumbnail">' + "<img src='...' alt='...'>" + '<div class="caption"><h3>' + artist['name'] + '</h3>' + '<p><b>profile url:</b> ' + artist['url'] + '</p>' + '<p>Listened by your firends:<b>' + str(result['sum(l.listening_count)']) + '</b> times</p>' + '<p>Listened by all: <b>' + str(artist['listening_count']) + '</b> times</p>' + '<p><b>' + str(artist['listener_count']) + '</b> listeners</p>' + '<p><a href="#" class="btn btn-primary" role="button">Listen</a></p></div></div></div>'
			...
			for result in top_5_artists_by_friends:
				artists_by_id = db.artists.find({"_id" : result["a.artistId"]})
				for artist in artists_by_id:
					artists_html += '<div class="col-sm-6 col-md-9"><div class="thumbnail">' + '<img src="..." alt="...">' + '<div class="caption"><h3>' + artist['name'] + '</h3>' + '<p><b>profile url:</b> ' + artist['url'] + '</p>' + '<p><b>' + str(result['count(*)']) + '</b> of your friends has listened</p>' + '<p>Listened by all: <b>' + str(artist['listening_count']) + '</b> times</p>' + '<p><b>' + str(artist['listener_count']) + '</b> listeners</p>' + '<p><a href="#" class="btn btn-primary" role="button">Listen</a></p></div></div></div>'
			...
			for result in top_5_artists_by_friends:
				artists_by_id = db.artists.find({"_id" : result["a.artistId"]})
				for artist in artists_by_id:
					artists_html += '<div class="col-sm-6 col-md-9"><div class="thumbnail">' + '<img src="..." alt="...">' + '<div class="caption"><h3>' + artist['name'] + '</h3>' + '<p><b>profile url:</b> ' + artist['url'] + '</p>' + '<p>tagged by: <b>' + str(result['tagPick']) + '</b></p>' + '<p>Listened by all: <b>' + str(artist['listening_count']) + '</b> times</p>' + '<p><b>' + str(artist['listener_count']) + '</b> listeners</p>' + '<p><a href="#" class="btn btn-primary" role="button">Listen</a></p></div></div></div>'
